    ...
    layers: [
        ...
        new ol.layer.Image({
            ...
            source: new ol.source.ImageWMS({
                url: "http://localhost:8080/geoserver/nhombaton/wms",
                params: {
                    LAYERS: "inhombaton:vinhtan_htsdd",
                },
                ratio: 1,
                serverType: "geoserver",
            }),
...
function legend() {
    ...
    for (i = 0; i < no_layers; i++) {
        ar.push(
            "http://localhost:8080/geoserver/nhombaton/wms?REQUEST=GetLegendGraphic&VERSION=1.0.0&FORMAT=image/png&WIDTH=20&HEIGHT=20&LAYER=" +
...
function add_draw_Interaction() {
    ...
    if (value !== "None") {
        ...
        if (
            draw_typeSelect.value == "select" ||
            draw_typeSelect.value == "clear"
        ) {
            ...
            draw_typeSelect.value == "Square" ||
            draw_typeSelect.value == "Polygon" ||
            draw_typeSelect.value == "Circle" ||
            draw_typeSelect.value == "Star" ||
            draw_typeSelect.value == "Box"
        ) {
            map.addInteraction(draw1);
